-- Multi-platform support (Oracle / SQL Server / PostgreSQL), RAC / cluster metadata,
-- and a SIT environment alongside the existing dev/uat/prod servers.
...
-- All existing seed rows are Oracle instances; flag two as RAC clusters.
UPDATE public.databases SET platform = 'oracle';
